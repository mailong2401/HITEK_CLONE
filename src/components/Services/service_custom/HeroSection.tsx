          ...
          >
            <div className="bg-black/40 backdrop-blur-md border border-white/10 rounded-2xl p-8 mb-12 shadow-2xl max-w-3xl mx-auto">
              <p className="text-xl text-white/90 leading-relaxed">
                Là một công ty phát triển phần mềm custom hàng đầu Việt Nam, chúng tôi đã hoàn thành xuất sắc hàng trăm dự án cho các khách hàng trên toàn thế giới. 
                <span className="block mt-4 font-semibold text-primary drop-shadow-lg">
                  Thành lập từ năm 2017, Hitek luôn áp dụng các công nghệ mới nhất với phương pháp phát triển tối ưu.
                </span>
              </p>
            </div>

  ...
  return (
    <>
      ...
      <div className="flex items-center gap-4 mb-10 opacity-0 animate-showContent">
        {/* Author */}
        <div className="author text-primary-foreground font-bold tracking-[0.3em] text-xs md:text-sm">
          {currentPost.author}
        </div>
        ...
        <div className="text-primary-foreground text-sm">
          <span className="text-primary font-bold">{currentIndex + 1}</span> / {blogPostsLength}
        </div>
      </div>
      ...
      {/* Topic - CANH TRÁI */}
      <div className="topic text-primary-foreground font-bold text-xl md:text-3xl lg:text-3xl mb-12 opacity-0 animate-showContent animation-delay-400">
